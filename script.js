...
const currentDataTxt = document.querySelector(".current-data-text");

const forcastItemContainer = document.querySelector(".forecast-item-container");


const apiKey = '3caaf52adb4c834f01e1cd07a6a48a26';
...
function updateForecastItems(weatherData) {
    ...
    const daeTaken = new Date(date)
    const dateOption = {
        day: '2-digit',
        month: 'short'
    }
    const dataResult = daeTaken.toLocaleDateString('en-US', dateOption)
